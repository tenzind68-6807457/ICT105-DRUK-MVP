...
|---|---|---|---|---|---|
| Idea 1: Tourism Information Platform | Simple website + content database prototype | HTML/CSS/JavaScript + Airtable Database | Attraction details, location, opening hours, transport options, accommodation info, service contacts, travel tips | Medium | Yes |
| Idea 2: Smart Campus Event Hub | Web app prototype + registration & notification system | HTML/CSS/JavaScript + Google Forms + Google Sheets Dashboard | Event title, date/time, location, description, organizer, registration details, reminder preferences | Medium | Yes |
